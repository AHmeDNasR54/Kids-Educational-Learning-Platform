...
namespace Ecommerce.DataAccess.Services.Auth
{
    public interface IAuthService
    {
        ...
        Task<Response<ParentRegisterResponse>> ParentRegisterAsync(ParentRegisterRequest registerRequest);

        Task<Response<TeacherRegisterResponse>> TeacherRegisterAsync(TeacherRegisterRequest registerRequest);

        Task<Response<bool>> VerifyEmailAsync(VerifyOtpRequest verifyOtpRequest);

        Task<Response<VerifyResetPasswordResponse>> VerifyResetPasswordAsync(VerifyOtpRequest verifyOtpRequest);
